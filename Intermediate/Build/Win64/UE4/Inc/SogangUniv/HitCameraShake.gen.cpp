...
#include "SogangUniv/Effect/HitCameraShake.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	SOGANGUNIV_API UClass* Z_Construct_UClass_UHitCameraShake_NoRegister();
	SOGANGUNIV_API UClass* Z_Construct_UClass_UHitCameraShake();
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UHitCameraShake_Statics::Class_MetaDataParams[] = {
		{ "Comment", "/**\n * \n */" },
		{ "IncludePath", "Effect/HitCameraShake.h" },
		{ "ModuleRelativePath", "Effect/HitCameraShake.h" },
	};
#endif
	...
	IMPLEMENT_CLASS(UHitCameraShake, 3745358562);
	template<> SOGANGUNIV_API UClass* StaticClass<UHitCameraShake>()
	{
		return UHitCameraShake::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UHitCameraShake(Z_Construct_UClass_UHitCameraShake, &UHitCameraShake::StaticClass, TEXT("/Script/SogangUniv"), TEXT("UHitCameraShake"), false, nullptr, nullptr, nullptr);
